class Knowhow < ApplicationRecord
  ...
  validates :create_user_id, presence: true, numericality: { only_integer: true }, on: :create
  ...
  belongs_to :create_user, class_name: "User", foreign_key: :create_user_id, primary_key: :id, optional: true
  # update_user_id は、user テーブルの外部キー。
  belongs_to :update_user, class_name: "User", foreign_key: :update_user_id, primary_key: :id, optional: true
